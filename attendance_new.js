...
class selfCheckInForm {
    ...
    getCheckInBtn() {
        var $this = this
        var checkInBtn = creEl(
            "button",
            "main-button red w-button check-in-btn",
            "check-in-btn",
        )
    ...
    getCheckInIcon() {
        ...
        img.src =
            "https://uploads-ssl.webflow.com/6271a4bf060d543533060f47/647062754a2e7d5b5208c785_square-check-red.svg"
        return img
    }
    ...
    callCheckedInApi() {
        ...
        var data = {
            ...
            timezoneId:
                labListSelect.value != "111" ? labListSelect.value : null,
        }
