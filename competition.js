...
class AccordionCompetition {
	...
	/**
	 * Display single accordion and competition data
	 */
	view() {
		var $this = this;
		if (this.$competition) {
	...
	/**
	 * Render single json competition data
	...
	/**
	 * Display Program name for single competition
	 */
	viewService() {
	...
	/**
	 * Get Checkbox icon for form complete or running
	 */
	...
	/**
	 * Get competition status as a text like it's completed or running
	 */
...
class AccordionTabs {
	...
	/**
	 * Render tabs for multiple competitions
	...
	/**
	 * Display live check-in notification message
	 * @param {*} notification 
	 * @returns 
	 */
	...
	/**
	 * API call for get live check-in data
	 */
