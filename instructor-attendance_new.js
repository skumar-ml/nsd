...
class checkInForm {
    ...
    resetFilter() {
        ...
        var studentCheckinFilter = document.getElementById(
            "student-checkin-filter",
        )
        if (studentData) {
            studentData.value = ""
        }
    ...
    createInstructorCheckInFilter() {
        ...
        var dateFilter = creEl(
            "select",
            "ins-checkin-filter w-select",
            "ins-checkin-filter",
        )
    ...
    createStudentCheckInFilter() {
        ...
        var dateFilter = creEl(
            "select",
            "student-checkin-filter w-select",
            "student-checkin-filter",
        )
        var defaultoption = creEl("option")
        defaultoption.value = ""
    ...
    makeAttendanceFilter() {
        ...
        /*Filter*/
        var attendanceHeader = creEl(
            "div",
            "attendance-header w-layout-grid grid-3",
            "attendance-header",
        )
    ...
    filterstudentData() {
        ...
        var timeZoneSelect =
            document.getElementsByClassName("select-timezones")[0]
        var insCheckinFilter = document.getElementById("ins-checkin-filter")
    ...
    get_session() {
        ...
        sessionSelectBox.addEventListener("change", function () {
            var selected_labs = labs.find(
                (item) => item.session.sessionId == this.value,
            )
            $this.$selected_labs =
                selected_labs != undefined ? selected_labs.lab : []
    ...
    hideStudentListList() {
        ...
        var studentListFilter = document.getElementsByClassName(
            "student-list-filter",
        )[0]
        var paginationStudentList = document.getElementsByClassName(
            "pagination-student-list",
        )[0]
    ...
    hideShowUI() {
        ...
        var timeZoneSelect =
            document.getElementsByClassName("select-timezones")[0]
        var _timeZoneSelect =
            document.getElementsByClassName("select_timezones")[0]
    ...
    displayStudentList(labId, type = "") {
        ...
        currentLabStudent.data.forEach((item, index) => {
            ...
            icon.addEventListener("click", function () {
                ...
                icon.src =
                    "https://cdn.jsdelivr.net/gh/sk1840939/nsd@044393b/loading.gif"
        ...
        //Pagination
        var paginationStuList = document.getElementById(
            "pagination-student-list",
        )
    ...
    getCheckInIcon() {
        ...
        img.src =
            "https://uploads-ssl.webflow.com/6271a4bf060d543533060f47/6437ec2c6bc4131717b36b93_checkin.svg"
        return img
    }
    ...
    createPagination() {
        ...
        if (this.$currentLabStudent.pre_page != null) {
            ...
            preBtn.addEventListener("click", function () {
                $this.$currentLabStudent = $this.paginatorList(
                    $this.$currentLab.studentData,
                    $this.$currentLabStudent.pre_page,
                )
                $this.refreshData()
            })
        ...
        if (this.$currentLabStudent.next_page != null) {
            ...
            nextBtn.addEventListener("click", function () {
                $this.$currentLabStudent = $this.paginatorList(
                    $this.$currentLab.studentData,
                    $this.$currentLabStudent.next_page,
                )
                $this.refreshData()
            })
    ...
    getUpdatedLabsData(labId) {
        ...
        xhr.open(
            "GET",
            ATTENDANCE_API_BASE +
                "/getAttendanceDetailsByMemberId/" +
        ...
        xhr.onload = function () {
            ...
            var selected_labs = responseText.find(
                (item) =>
                    item.session.sessionId == selectedLabs.session.sessionId,
            )
            ...
            $this.$currentLab = currentLab
            $this.$currentLabStudent = $this.paginatorList(
                currentLab.studentData,
                $this.$currentLabStudent.page,
            )
            $this.refreshData()
        }
    }
