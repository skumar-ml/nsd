...
function creEl(name,className,idName){
  ...
  class checkInForm {
	  ...
	  filterstudentData(){
		  ...
		  console.log('studentData before', studentData)
		  ...
		  console.log('studentData before 1', studentData)
		  ...
		  console.log('studentData before 2', studentData)
		  ...
		  console.log('studentData Filter 3', studentData)
	  ...
	  refreshData(){
		  ...
		  studentlist.innerHTML = "";
		  paginationStuList.innerHTML = "";
		  var labsSelectBox = document.getElementById('select-timezone');
