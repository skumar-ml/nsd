...
class CheckOutWebflow {
  ...
  initializeStripePayment() {
    ...
    var data = {
      ...
      //"paymentType" : type,
      successUrl:
        "https://www.nsdebatecamp.com/payment-confirmation?programName=" +
        this.memberData.programName,
    ...
    xhr.open(
      "POST",
      "https://3yf0irxn2c.execute-api.us-west-1.amazonaws.com/dev/camp/createBothCheckoutUrls",
      true
    );
