            ...
            if (formData.failedPayment == undefined) {
                ...
                if (!is_single) {
                    ...
                    tabsE.innerHTML =
                        ...
                        " " +
                        formData.programCategory.programCategoryName +
                        "(" +
                        formData.studentDetail.currentYear +
                        ")"
                ...
                var activeClass =
                    currentIndex == 1 && is_single ? "active_tab" : ""
