...
class CheckOutWebflow extends BriefsUpsellModal {
                ...
                if (programDetailId == suppId) {
                    ...
                    if (checkbox.checked) {
                        ...
                        if (checkbox.closest(".you-might_slide-item")) {
                            checkbox
                                .closest(".you-might_slide-item")
                                .classList.toggle("border-red")
                        }
                    }
    ...
    reinitializePaymentTab() {
        ...
        document.getElementById("pay-now-link").closest("div").style.display =
            "none"
        document.getElementById("pay-now-link-2").closest("div").style.display =
            "none"
        document.getElementById("pay-now-link-3").closest("div").style.display =
            "none"
    ...
    eventForPayNowBtn() {
        ...
        payNowLink.addEventListener("click", function (e) {
            ...
            let activePaymentLink = document.querySelector(
        ...
        addToCartButtons.forEach((button) => {
            button.addEventListener("click", function (event) {
                ...
                if (parent) {
                    ...
                    if (checkbox) {
                        ...
                        const isCurrentlySelected =
                            selectedIds.includes(programDetailId)
                        ...
                        if (button.closest(".you-might_slide-item")) {
                            button
                                .closest(".you-might_slide-item")
                                .classList.toggle("border-red", isChecked)
                        }

                        // Update the same program buttons in other sections
                        if (programDetailId) {
                            var elementSelector =
                                ".supp_program_" + programDetailId
                            var matchedAddCartBtn =
                                document.querySelectorAll(elementSelector)
                            matchedAddCartBtn.forEach((add_to_card_btn) => {
                                add_to_card_btn.textContent = isChecked
                                    ? "Remove"
                                    : "Add"
                                add_to_card_btn.style.pointerEvents = "auto" // Keep it clickable
                                const matchedParent =
                                    add_to_card_btn.closest("div")
                                const matchedCheckbox = matchedParent
                                    ? matchedParent.querySelector(
                                          ".suppCheckbox",
                                      )
                                    : null
                                if (matchedCheckbox) {
                                ...
                                if (
                                    add_to_card_btn.closest(
                                        ".you-might_slide-item",
                                    )
                                ) {
                                    add_to_card_btn
                                        .closest(".you-might_slide-item")
                                ...
                                if (isChecked) {
                                    add_to_card_btn.style.color = "#ffffff"
                                    add_to_card_btn.style.backgroundColor =
                                        "gray"
                                } else {
                ...
                if (this.classList.contains("care_package_add_to_card")) {
                    ...
                    const careCheckbox = careParent
                        ? careParent.querySelector(".suppCheckbox")
                        : null
                    const isChecked = careCheckbox
                        ? careCheckbox.checked
                        : false
    ...
    async displaySupplementaryProgram() {
        ...
        let swiperSlideWrapper = container2.querySelector(
            ".you-might_slick-slider",
        )

        // New Slider with add-to-cart and learn more button
        let container3 = document.getElementById(
            "checkout-supplimentary-data-desktop",
        )
        let newSlideWrapper = container3.querySelector(
            ".you-might-slider-container",
        )

        // For Mobile Slider
        let container4 = document.getElementById(
            "checkout-supplimentary-data-mobile",
        )
        let mobileSlideWrapper = container4.querySelector(
            ".you-might-slider-container-mobile",
        )
        ...
        let apiData = await this.fetchData(
            PAYMENT_API_BASE,
            "/getSupplementaryProgram/" + this.memberData.programId,
        )
        ...
        apiData.forEach((item) => {
            ...
            const outerShadowDiv1 = this.displaySingleSuppProgram(
                item,
                "desktop",
                swiperSlide,
            )
            ...
            const newOuterShadowDiv1 = this.newDisplaySingleSuppProgram(
                item,
                "desktop",
                newSliderSlide,
            )
            ...
            const mobileOuterShadowDiv1 = this.newDisplaySingleSuppProgram(
                item,
                "desktop",
                mobileSliderSlide,
            )
    ...
    activeBreadCrumb(activeId) {
        let breadCrumbList = document.querySelectorAll(
